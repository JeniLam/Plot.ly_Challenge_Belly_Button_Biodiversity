...
// wrap the below into a function to grab the metadata (filter for results in there (an array of dictionaries where the console.log is)) line with D3 to select to panel close with ."html"("")
...
// the below is for the charts (need to update the code)

// For bar graph will need to slice(0,10) and reverse
function init(){
